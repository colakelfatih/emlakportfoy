              ...
              <ul class="menu-nav">
                ...
                <li class="menu-item" aria-haspopup="true">
                 ...
                 <li class="menu-section">
                  <h4 class="menu-text">Portföyler</h4>
                  <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
				        <li class="menu-item" aria-haspopup="true">
                  <a href="{{ route('pages.portfoy.PortfoyGiris') }}" class="menu-link">
                  <i class="menu-icon flaticon-layers"></i>
                  <span class="menu-text">Portföy Girişi </span>
                  </a>
                </li>
                <li class="menu-item" aria-haspopup="true">
